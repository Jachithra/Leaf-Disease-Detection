    ...
    public partial class F_1_MainForm : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked)
                _cnn1 = new CNNData(bc, Convert.ToInt32(txtNumClusters.Text), Skincancerdetction.Colour.Types.RGB);
            else
                _cnn1 = new CNNData(bc, Convert.ToInt32(txtNumClusters.Text), Skincancerdetction.Colour.Types.HSV);
            timer1.Enabled = true;
